...
void JogwheelLookAndFeel::drawRotarySlider(Graphics &g, int x, int y, int width, int height, float sliderPos,
    ...
    /**
     * N.B. the code below is built upon from the code provided in the drawRotarySlider function itself
     * */
    ...
    g.fillEllipse(bounds.getCentreX() - innerRadius, bounds.getCentreY() - innerRadius, innerRadius * 2,
                  innerRadius * 2);
}